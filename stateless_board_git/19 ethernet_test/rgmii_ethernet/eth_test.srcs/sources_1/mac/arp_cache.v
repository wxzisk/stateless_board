...
always @(posedge clk or negedge rst_n)
  begin
    if (~rst_n)
      arp_cache  <= 80'h00_00_00_00_00_02_c9_05_6a_22 ;
    else if (arp_found)
...
always @(posedge clk or negedge rst_n)
  begin
    if (~rst_n)
      destination_mac_addr  <= 48'h00_02_c9_05_6a_22 ;
...
always @(posedge clk or negedge rst_n)
  begin
    if (~rst_n)
      ...
      mac_not_exist  <= 1'b1 ;
    else if (destination_ip_addr == arp_cache[79:48] && arp_cache[47:0] == 48'h00_02_c9_05_6a_22)
      mac_not_exist  <= 1'b1 ;
    else
      mac_not_exist  <= 1'b0 ;
  end
