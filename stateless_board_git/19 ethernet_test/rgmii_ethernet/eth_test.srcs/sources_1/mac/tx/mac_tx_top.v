...
//         input  [7:0]         ram_wr_data,//original version(8 bits)
         ...
         output               mac_send_end,
//         output [7:0]         mac_tx_data//original version(8 bits)
        output[63:0]                mac_tx_data,
        
// get the ip data and  ip_sending out   
        output[63:0]          ip_tx_data,
        output                ip_sending,
//snd IB header
...
wire                  mac_data_req ;
wire [63:0]            mac_frame_data ;//original version(8 bits)
wire                  mac_tx_ready ;
wire                  mac_tx_end ;

wire                  ip_tx_ready ;
//wire [63:0]            ip_tx_data ;//original version(8 bits)
wire                  ip_tx_end ;
