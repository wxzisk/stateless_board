...
//Command     : generate_target bd_design.bd
//Design      : bd_design
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_design,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=5,numNonXlnxBlks=0,numHierBlks=2,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=1,da_bram_cntlr_cnt=2,da_clkrst_cnt=2,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "bd_design.hwdef" *) 
module bd_design
   (addrb_0,
    axi_aclk,
    dinb_0,
    ...
    web_0);
  input [31:0]addrb_0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.AXI_ACLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.AXI_ACLK, CLK_DOMAIN bd_design_xdma_0_0_axi_aclk, FREQ_HZ 250000000, PHASE 0.000" *) output axi_aclk;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.DINB_0 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.DINB_0, LAYERED_METADATA undef" *) input [63:0]dinb_0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.DOUTB_0 DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.DOUTB_0, LAYERED_METADATA undef" *) output [63:0]doutb_0;
  input enb_0;
  ...
  bd_design_axi_interconnect_0_0 axi_interconnect_0
  ...
  bd_design_blk_mem_gen_0_0 blk_mem_gen_0
...
module bd_design_axi_interconnect_0_0
   (ACLK,
    ARESETN,
    M00_ACLK,
    M00_ARESETN,
  ...
  s00_couplers_imp_17Y171J s00_couplers
...
module s00_couplers_imp_17Y171J
   (M_ACLK,
    M_ARESETN,
    M_AXI_araddr,
    M_AXI_arburst,
