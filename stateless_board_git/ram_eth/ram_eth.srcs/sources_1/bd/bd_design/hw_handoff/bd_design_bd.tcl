...
proc create_root_design { parentCell } {
  ...
  set dinb_0 [ create_bd_port -dir I -from 63 -to 0 -type data dinb_0 ]
  set doutb_0 [ create_bd_port -dir O -from 63 -to 0 -type data doutb_0 ]
  ...
  set web_0 [ create_bd_port -dir I -from 7 -to 0 web_0 ]
  ...
  connect_bd_intf_net -intf_net CLK_IN_D_0_1 [get_bd_intf_ports refclk] [get_bd_intf_pins util_ds_buf_0/CLK_IN_D]
  ...
  connect_bd_net -net sys_rst_n_0_1 [get_bd_ports reset_n] [get_bd_pins xdma_0/sys_rst_n]
  ...
  connect_bd_net -net xdma_0_axi_aclk [get_bd_ports axi_aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins xdma_0/axi_aclk]
  connect_bd_net -net xdma_0_axi_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins xdma_0/axi_aresetn]
