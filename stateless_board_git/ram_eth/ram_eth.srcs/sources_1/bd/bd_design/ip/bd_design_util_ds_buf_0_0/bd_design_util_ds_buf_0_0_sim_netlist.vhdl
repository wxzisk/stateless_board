...
-- Date        : Tue Jan  7 18:01:09 2020
-- Host        : WIN-6LRTIFRL70S running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top bd_design_util_ds_buf_0_0 -prefix
--               bd_design_util_ds_buf_0_0_ bd_design_util_ds_buf_0_0_sim_netlist.vhdl
-- Design      : bd_design_util_ds_buf_0_0
...
entity bd_design_util_ds_buf_0_0_util_ds_buf is
  port (
  ...
  attribute C_BUF_TYPE of bd_design_util_ds_buf_0_0_util_ds_buf : entity is "ibufdsgte3";
  attribute C_SIZE : integer;
  attribute C_SIZE of bd_design_util_ds_buf_0_0_util_ds_buf : entity is 1;
end bd_design_util_ds_buf_0_0_util_ds_buf;

architecture STRUCTURE of bd_design_util_ds_buf_0_0_util_ds_buf is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity bd_design_util_ds_buf_0_0 is
  port (
    IBUF_DS_P : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_DS_N : in STD_LOGIC_VECTOR ( 0 to 0 );
    IBUF_OUT : out STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute NotValidForBitStream of bd_design_util_ds_buf_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of bd_design_util_ds_buf_0_0 : entity is "bd_design_util_ds_buf_0_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of bd_design_util_ds_buf_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of bd_design_util_ds_buf_0_0 : entity is "util_ds_buf,Vivado 2017.4";
end bd_design_util_ds_buf_0_0;

architecture STRUCTURE of bd_design_util_ds_buf_0_0 is
  ...
  attribute x_interface_parameter of IBUF_DS_ODIV2 : signal is "XIL_INTERFACENAME IBUF_DS_ODIV2, FREQ_HZ 100000000, CLK_DOMAIN bd_design_util_ds_buf_0_0_IBUF_DS_ODIV2";
  ...
  attribute x_interface_parameter of IBUF_OUT : signal is "XIL_INTERFACENAME IBUF_OUT, FREQ_HZ 100000000, CLK_DOMAIN bd_design_util_ds_buf_0_0_IBUF_OUT";
begin
U0: entity work.bd_design_util_ds_buf_0_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_I(0) => '0',
